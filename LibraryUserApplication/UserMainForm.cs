        ...
        private void OpenForm(menuChoises choise)
        {
            switch (choise)
            {
                case menuChoises.Login:
                    {
                        UserLoginForm userLoginForm = new UserLoginForm(this, authController);
                        userLoginForm.ShowDialog();
                        break;
                    }
                case menuChoises.Intake:
                    {
                        UserIntakeForm userIntakeForm = new UserIntakeForm(this);
                        userIntakeForm.Show();
                        this.Hide();
                        break;
                    }
                case menuChoises.Dispense:
                    {
                        UserDispenseForm userDispenseForm = new UserDispenseForm(this);
                        userDispenseForm.Show();
                        this.Hide();
                        break;
                    }
                case menuChoises.SearchItem:
                    {
                        UserItemSearchForm userItemSearchForm = new UserItemSearchForm(this);
                        userItemSearchForm.Show();
                        this.Hide();
                        break;
                    }
                case menuChoises.ConnectToServer:
                    {
                        UserServerConnectForm userServerConnectForm = new UserServerConnectForm(this, connectionController);
                        userServerConnectForm.ShowDialog();
                        break;
                    }
            }
        }
